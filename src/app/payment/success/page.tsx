  ...
  useEffect(() => {
    ...
    const verifyAndLoadOrder = async () => {
      ...
      try {
        ...
        // ⚠️ Dodo Payments 자동 완료 로직은 제거되었습니다.
        //   기존 로직은 return URL 쿼리스트링(?status=succeeded&payment_id=...)만으로
        //   결제 증명 없이 주문을 완료 처리할 수 있어 결제 우회 취약점이 있었습니다.
        //   모든 결제 완료는 서버 측 검증(PortOne verify / PayPal capture / 포인트 / 관리자)으로만 처리됩니다.
