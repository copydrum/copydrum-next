export default {
  ...
  'footer.address': 'Адрес: помещение 113, 1-й этаж, Jebi-dong, ул. Ханнури, 2200, Седжон, Республика Корея',
  ...
  'footer.contactInfoGlobal': 'Контакт: 070-7570-0028 (Телефонная поддержка ограничена в рабочее время. Пожалуйста, используйте значок чата в правом нижнем углу экрана.)',
