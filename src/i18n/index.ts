...
import koSheetBooks from './locales/ko/sheetBooks.json';
...
import enSheetBooks from './locales/en/sheetBooks.json';
...
import jaSheetBooks from './locales/ja/sheetBooks.json';
...
import deSheetBooks from './locales/de/sheetBooks.json';
...
import esSheetBooks from './locales/es/sheetBooks.json';
...
import frSheetBooks from './locales/fr/sheetBooks.json';
...
import hiSheetBooks from './locales/hi/sheetBooks.json';
...
import idSheetBooks from './locales/id/sheetBooks.json';
...
import itSheetBooks from './locales/it/sheetBooks.json';
...
import ptSheetBooks from './locales/pt/sheetBooks.json';
...
import ruSheetBooks from './locales/ru/sheetBooks.json';
...
import thSheetBooks from './locales/th/sheetBooks.json';
...
import trSheetBooks from './locales/tr/sheetBooks.json';
...
import ukSheetBooks from './locales/uk/sheetBooks.json';
...
import viSheetBooks from './locales/vi/sheetBooks.json';
...
import zhCNSheetBooks from './locales/zh-CN/sheetBooks.json';
...
import zhTWSheetBooks from './locales/zh-TW/sheetBooks.json';

// JSON 파일을 언어별로 그룹화
type JsonModule = Record<string, unknown>;
const jsonFilesByLang: Record<string, Record<string, JsonModule>> = {
  ko: { authCallback: koAuthCallback, authForgotPassword: koAuthForgotPassword, authLogin: koAuthLogin, authRegister: koAuthRegister, authResetPassword: koAuthResetPassword, cartPage: koCartPage, categoriesPage: koCategoriesPage, checkout: koCheckout, collectionsDetail: koCollectionsDetail, collectionsPage: koCollectionsPage, companyAbout: koCompanyAbout, companyPartnership: koCompanyPartnership, common: koCommon, customerSupport: koCustomerSupport, customOrder: koCustomOrder, customOrderDetail: koCustomOrderDetail, customOrders: koCustomOrders, eventSale: koEventSale, freeSheets: koFreeSheets, guidePage: koGuidePage, home: koHome, myOrders: koMyOrders, mypage: koMypage, notFound: koNotFound, refundPolicy: koRefundPolicy, seo: koSeo, sheetDetail: koSheetDetail, sidebar: koSidebar, sheetBooks: koSheetBooks, paymentSuccess: koPaymentSuccess },
  en: { authCallback: enAuthCallback, authForgotPassword: enAuthForgotPassword, authLogin: enAuthLogin, authRegister: enAuthRegister, authResetPassword: enAuthResetPassword, cartPage: enCartPage, categoriesPage: enCategoriesPage, checkout: enCheckout, collectionsDetail: enCollectionsDetail, collectionsPage: enCollectionsPage, companyAbout: enCompanyAbout, companyPartnership: enCompanyPartnership, common: enCommon, customerSupport: enCustomerSupport, customOrder: enCustomOrder, customOrderDetail: enCustomOrderDetail, customOrders: enCustomOrders, eventSale: enEventSale, freeSheets: enFreeSheets, guidePage: enGuidePage, home: enHome, myOrders: enMyOrders, mypage: enMypage, notFound: enNotFound, refundPolicy: enRefundPolicy, seo: enSeo, sheetDetail: enSheetDetail, sidebar: enSidebar, sheetBooks: enSheetBooks, paymentSuccess: enPaymentSuccess },
  ja: { authCallback: jaAuthCallback, authForgotPassword: jaAuthForgotPassword, authLogin: jaAuthLogin, authRegister: jaAuthRegister, authResetPassword: jaAuthResetPassword, cartPage: jaCartPage, categoriesPage: jaCategoriesPage, checkout: jaCheckout, collectionsDetail: jaCollectionsDetail, collectionsPage: jaCollectionsPage, companyAbout: jaCompanyAbout, companyPartnership: jaCompanyPartnership, common: jaCommon, customerSupport: jaCustomerSupport, customOrder: jaCustomOrder, customOrderDetail: jaCustomOrderDetail, customOrders: jaCustomOrders, eventSale: jaEventSale, freeSheets: jaFreeSheets, guidePage: jaGuidePage, home: jaHome, myOrders: jaMyOrders, mypage: jaMypage, notFound: jaNotFound, refundPolicy: jaRefundPolicy, seo: jaSeo, sheetDetail: jaSheetDetail, sidebar: jaSidebar, sheetBooks: jaSheetBooks, paymentSuccess: jaPaymentSuccess },
  de: { authCallback: deAuthCallback, authForgotPassword: deAuthForgotPassword, authLogin: deAuthLogin, authRegister: deAuthRegister, authResetPassword: deAuthResetPassword, cartPage: deCartPage, categoriesPage: deCategoriesPage, checkout: deCheckout, collectionsDetail: deCollectionsDetail, collectionsPage: deCollectionsPage, companyAbout: deCompanyAbout, companyPartnership: deCompanyPartnership, common: deCommon, customerSupport: deCustomerSupport, customOrder: deCustomOrder, customOrderDetail: deCustomOrderDetail, customOrders: deCustomOrders, eventSale: deEventSale, freeSheets: deFreeSheets, guidePage: deGuidePage, home: deHome, myOrders: deMyOrders, mypage: deMypage, notFound: deNotFound, refundPolicy: deRefundPolicy, seo: deSeo, sheetDetail: deSheetDetail, sidebar: deSidebar, sheetBooks: deSheetBooks, paymentSuccess: dePaymentSuccess },
  es: { authCallback: esAuthCallback, authForgotPassword: esAuthForgotPassword, authLogin: esAuthLogin, authRegister: esAuthRegister, authResetPassword: esAuthResetPassword, cartPage: esCartPage, categoriesPage: esCategoriesPage, checkout: esCheckout, collectionsDetail: esCollectionsDetail, collectionsPage: esCollectionsPage, companyAbout: esCompanyAbout, companyPartnership: esCompanyPartnership, common: esCommon, customerSupport: esCustomerSupport, customOrder: esCustomOrder, customOrderDetail: esCustomOrderDetail, customOrders: esCustomOrders, eventSale: esEventSale, freeSheets: esFreeSheets, guidePage: esGuidePage, home: esHome, myOrders: esMyOrders, mypage: esMypage, notFound: esNotFound, refundPolicy: esRefundPolicy, seo: esSeo, sheetDetail: esSheetDetail, sidebar: esSidebar, sheetBooks: esSheetBooks, paymentSuccess: esPaymentSuccess },
  fr: { authCallback: frAuthCallback, authForgotPassword: frAuthForgotPassword, authLogin: frAuthLogin, authRegister: frAuthRegister, authResetPassword: frAuthResetPassword, cartPage: frCartPage, categoriesPage: frCategoriesPage, checkout: frCheckout, collectionsDetail: frCollectionsDetail, collectionsPage: frCollectionsPage, companyAbout: frCompanyAbout, companyPartnership: frCompanyPartnership, common: frCommon, customerSupport: frCustomerSupport, customOrder: frCustomOrder, customOrderDetail: frCustomOrderDetail, customOrders: frCustomOrders, eventSale: frEventSale, freeSheets: frFreeSheets, guidePage: frGuidePage, home: frHome, myOrders: frMyOrders, mypage: frMypage, notFound: frNotFound, refundPolicy: frRefundPolicy, seo: frSeo, sheetDetail: frSheetDetail, sidebar: frSidebar, sheetBooks: frSheetBooks, paymentSuccess: frPaymentSuccess },
  hi: { authCallback: hiAuthCallback, authForgotPassword: hiAuthForgotPassword, authLogin: hiAuthLogin, authRegister: hiAuthRegister, authResetPassword: hiAuthResetPassword, cartPage: hiCartPage, categoriesPage: hiCategoriesPage, checkout: hiCheckout, collectionsDetail: hiCollectionsDetail, collectionsPage: hiCollectionsPage, companyAbout: hiCompanyAbout, companyPartnership: hiCompanyPartnership, common: hiCommon, customerSupport: hiCustomerSupport, customOrder: hiCustomOrder, customOrderDetail: hiCustomOrderDetail, customOrders: hiCustomOrders, eventSale: hiEventSale, freeSheets: hiFreeSheets, guidePage: hiGuidePage, home: hiHome, myOrders: hiMyOrders, mypage: hiMypage, notFound: hiNotFound, refundPolicy: hiRefundPolicy, seo: hiSeo, sheetDetail: hiSheetDetail, sidebar: hiSidebar, sheetBooks: hiSheetBooks, paymentSuccess: hiPaymentSuccess },
  id: { authCallback: idAuthCallback, authForgotPassword: idAuthForgotPassword, authLogin: idAuthLogin, authRegister: idAuthRegister, authResetPassword: idAuthResetPassword, cartPage: idCartPage, categoriesPage: idCategoriesPage, checkout: idCheckout, collectionsDetail: idCollectionsDetail, collectionsPage: idCollectionsPage, companyAbout: idCompanyAbout, companyPartnership: idCompanyPartnership, common: idCommon, customerSupport: idCustomerSupport, customOrder: idCustomOrder, customOrderDetail: idCustomOrderDetail, customOrders: idCustomOrders, eventSale: idEventSale, freeSheets: idFreeSheets, guidePage: idGuidePage, home: idHome, myOrders: idMyOrders, mypage: idMypage, notFound: idNotFound, refundPolicy: idRefundPolicy, seo: idSeo, sheetDetail: idSheetDetail, sidebar: idSidebar, sheetBooks: idSheetBooks, paymentSuccess: idPaymentSuccess },
  it: { authCallback: itAuthCallback, authForgotPassword: itAuthForgotPassword, authLogin: itAuthLogin, authRegister: itAuthRegister, authResetPassword: itAuthResetPassword, cartPage: itCartPage, categoriesPage: itCategoriesPage, checkout: itCheckout, collectionsDetail: itCollectionsDetail, collectionsPage: itCollectionsPage, companyAbout: itCompanyAbout, companyPartnership: itCompanyPartnership, common: itCommon, customerSupport: itCustomerSupport, customOrder: itCustomOrder, customOrderDetail: itCustomOrderDetail, customOrders: itCustomOrders, eventSale: itEventSale, freeSheets: itFreeSheets, guidePage: itGuidePage, home: itHome, myOrders: itMyOrders, mypage: itMypage, notFound: itNotFound, refundPolicy: itRefundPolicy, seo: itSeo, sheetDetail: itSheetDetail, sidebar: itSidebar, sheetBooks: itSheetBooks, paymentSuccess: itPaymentSuccess },
  pt: { authCallback: ptAuthCallback, authForgotPassword: ptAuthForgotPassword, authLogin: ptAuthLogin, authRegister: ptAuthRegister, authResetPassword: ptAuthResetPassword, cartPage: ptCartPage, categoriesPage: ptCategoriesPage, checkout: ptCheckout, collectionsDetail: ptCollectionsDetail, collectionsPage: ptCollectionsPage, companyAbout: ptCompanyAbout, companyPartnership: ptCompanyPartnership, common: ptCommon, customerSupport: ptCustomerSupport, customOrder: ptCustomOrder, customOrderDetail: ptCustomOrderDetail, customOrders: ptCustomOrders, eventSale: ptEventSale, freeSheets: ptFreeSheets, guidePage: ptGuidePage, home: ptHome, myOrders: ptMyOrders, mypage: ptMypage, notFound: ptNotFound, refundPolicy: ptRefundPolicy, seo: ptSeo, sheetDetail: ptSheetDetail, sidebar: ptSidebar, sheetBooks: ptSheetBooks, paymentSuccess: ptPaymentSuccess },
  ru: { authCallback: ruAuthCallback, authForgotPassword: ruAuthForgotPassword, authLogin: ruAuthLogin, authRegister: ruAuthRegister, authResetPassword: ruAuthResetPassword, cartPage: ruCartPage, categoriesPage: ruCategoriesPage, checkout: ruCheckout, collectionsDetail: ruCollectionsDetail, collectionsPage: ruCollectionsPage, companyAbout: ruCompanyAbout, companyPartnership: ruCompanyPartnership, common: ruCommon, customerSupport: ruCustomerSupport, customOrder: ruCustomOrder, customOrderDetail: ruCustomOrderDetail, customOrders: ruCustomOrders, eventSale: ruEventSale, freeSheets: ruFreeSheets, guidePage: ruGuidePage, home: ruHome, myOrders: ruMyOrders, mypage: ruMypage, notFound: ruNotFound, refundPolicy: ruRefundPolicy, seo: ruSeo, sheetDetail: ruSheetDetail, sidebar: ruSidebar, sheetBooks: ruSheetBooks, paymentSuccess: ruPaymentSuccess },
  th: { authCallback: thAuthCallback, authForgotPassword: thAuthForgotPassword, authLogin: thAuthLogin, authRegister: thAuthRegister, authResetPassword: thAuthResetPassword, cartPage: thCartPage, categoriesPage: thCategoriesPage, checkout: thCheckout, collectionsDetail: thCollectionsDetail, collectionsPage: thCollectionsPage, companyAbout: thCompanyAbout, companyPartnership: thCompanyPartnership, common: thCommon, customerSupport: thCustomerSupport, customOrder: thCustomOrder, customOrderDetail: thCustomOrderDetail, customOrders: thCustomOrders, eventSale: thEventSale, freeSheets: thFreeSheets, guidePage: thGuidePage, home: thHome, myOrders: thMyOrders, mypage: thMypage, notFound: thNotFound, refundPolicy: thRefundPolicy, seo: thSeo, sheetDetail: thSheetDetail, sidebar: thSidebar, sheetBooks: thSheetBooks, paymentSuccess: thPaymentSuccess },
  tr: { authCallback: trAuthCallback, authForgotPassword: trAuthForgotPassword, authLogin: trAuthLogin, authRegister: trAuthRegister, authResetPassword: trAuthResetPassword, cartPage: trCartPage, categoriesPage: trCategoriesPage, checkout: trCheckout, collectionsDetail: trCollectionsDetail, collectionsPage: trCollectionsPage, companyAbout: trCompanyAbout, companyPartnership: trCompanyPartnership, common: trCommon, customerSupport: trCustomerSupport, customOrder: trCustomOrder, customOrderDetail: trCustomOrderDetail, customOrders: trCustomOrders, eventSale: trEventSale, freeSheets: trFreeSheets, guidePage: trGuidePage, home: trHome, myOrders: trMyOrders, mypage: trMypage, notFound: trNotFound, refundPolicy: trRefundPolicy, seo: trSeo, sheetDetail: trSheetDetail, sidebar: trSidebar, sheetBooks: trSheetBooks, paymentSuccess: trPaymentSuccess },
  uk: { authCallback: ukAuthCallback, authForgotPassword: ukAuthForgotPassword, authLogin: ukAuthLogin, authRegister: ukAuthRegister, authResetPassword: ukAuthResetPassword, cartPage: ukCartPage, categoriesPage: ukCategoriesPage, checkout: ukCheckout, collectionsDetail: ukCollectionsDetail, collectionsPage: ukCollectionsPage, companyAbout: ukCompanyAbout, companyPartnership: ukCompanyPartnership, common: ukCommon, customerSupport: ukCustomerSupport, customOrder: ukCustomOrder, customOrderDetail: ukCustomOrderDetail, customOrders: ukCustomOrders, eventSale: ukEventSale, freeSheets: ukFreeSheets, guidePage: ukGuidePage, home: ukHome, myOrders: ukMyOrders, mypage: ukMypage, notFound: ukNotFound, refundPolicy: ukRefundPolicy, seo: ukSeo, sheetDetail: ukSheetDetail, sidebar: ukSidebar, sheetBooks: ukSheetBooks, paymentSuccess: ukPaymentSuccess },
  vi: { authCallback: viAuthCallback, authForgotPassword: viAuthForgotPassword, authLogin: viAuthLogin, authRegister: viAuthRegister, authResetPassword: viAuthResetPassword, cartPage: viCartPage, categoriesPage: viCategoriesPage, checkout: viCheckout, collectionsDetail: viCollectionsDetail, collectionsPage: viCollectionsPage, companyAbout: viCompanyAbout, companyPartnership: viCompanyPartnership, common: viCommon, customerSupport: viCustomerSupport, customOrder: viCustomOrder, customOrderDetail: viCustomOrderDetail, customOrders: viCustomOrders, eventSale: viEventSale, freeSheets: viFreeSheets, guidePage: viGuidePage, home: viHome, myOrders: viMyOrders, mypage: viMypage, notFound: viNotFound, refundPolicy: viRefundPolicy, seo: viSeo, sheetDetail: viSheetDetail, sidebar: viSidebar, sheetBooks: viSheetBooks, paymentSuccess: viPaymentSuccess },
  'zh-CN': { authCallback: zhCNAuthCallback, authForgotPassword: zhCNAuthForgotPassword, authLogin: zhCNAuthLogin, authRegister: zhCNAuthRegister, authResetPassword: zhCNAuthResetPassword, cartPage: zhCNCartPage, categoriesPage: zhCNCategoriesPage, checkout: zhCNCheckout, collectionsDetail: zhCNCollectionsDetail, collectionsPage: zhCNCollectionsPage, companyAbout: zhCNCompanyAbout, companyPartnership: zhCNCompanyPartnership, common: zhCNCommon, customerSupport: zhCNCustomerSupport, customOrder: zhCNCustomOrder, customOrderDetail: zhCNCustomOrderDetail, customOrders: zhCNCustomOrders, eventSale: zhCNEventSale, freeSheets: zhCNFreeSheets, guidePage: zhCNGuidePage, home: zhCNHome, myOrders: zhCNMyOrders, mypage: zhCNMypage, notFound: zhCNNotFound, refundPolicy: zhCNRefundPolicy, seo: zhCNSeo, sheetDetail: zhCNSheetDetail, sidebar: zhCNSidebar, sheetBooks: zhCNSheetBooks, paymentSuccess: zhCNPaymentSuccess },
  'zh-TW': { authCallback: zhTWAuthCallback, authForgotPassword: zhTWAuthForgotPassword, authLogin: zhTWAuthLogin, authRegister: zhTWAuthRegister, authResetPassword: zhTWAuthResetPassword, cartPage: zhTWCartPage, categoriesPage: zhTWCategoriesPage, checkout: zhTWCheckout, collectionsDetail: zhTWCollectionsDetail, collectionsPage: zhTWCollectionsPage, companyAbout: zhTWCompanyAbout, companyPartnership: zhTWCompanyPartnership, common: zhTWCommon, customerSupport: zhTWCustomerSupport, customOrder: zhTWCustomOrder, customOrderDetail: zhTWCustomOrderDetail, customOrders: zhTWCustomOrders, eventSale: zhTWEventSale, freeSheets: zhTWFreeSheets, guidePage: zhTWGuidePage, home: zhTWHome, myOrders: zhTWMyOrders, mypage: zhTWMypage, notFound: zhTWNotFound, refundPolicy: zhTWRefundPolicy, seo: zhTWSeo, sheetDetail: zhTWSheetDetail, sidebar: zhTWSidebar, sheetBooks: zhTWSheetBooks, paymentSuccess: zhTWPaymentSuccess },
};
